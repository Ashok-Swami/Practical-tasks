...
class Subcategory extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $response['allcategory'] = $this->Products_Model->subcategory_view();
        // echo"<pre>";
        // print_r($response);
        $this->load->view('subcategory/subcategory_list', $response);
    }
    public function create_subcategory()
    {
        $response['all_category'] = $this->Products_Model->get_all('product_category_master');
        $this->load->view('subcategory/subcategory_create',$response);
    }
    public function check_unique()
    {
        ...
        if ($response == 0) {
            ...
            print json_encode(array('status' => '0', 'msg' => ' This product  subcategory name already exists'));
            die;
        }
    }
}
